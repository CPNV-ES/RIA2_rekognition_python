...
class ImageAnalyserHelperTestCase(unittest.IsolatedAsyncioTestCase):
    ...
    def setUp(self):
        ...
        shutil.copyfile(self.image_name, "./tests/" + self.image_name)
        self.picture = open("./tests/" + self.image_name, "rb")
        ...
        self.expected_json = face_from_local_file(self.image_name)
    ...
    async def test_analyse_localfile_success(self):
        ...
        actual_json = face_from_local_file(self.image_name)
